...
public:
   ...
   // Equalivant operator for iterator, not equals
   void test_equals_not()
   {  // setup
      custom::BST<Spy>::iterator itLHS;
      custom::BST<Spy>::iterator itRHS;
      itLHS.pNode = (custom::BST<Spy>::BNode*)0xbaadf00d;
      itRHS.pNode = (custom::BST<Spy>::BNode*)0xf00dbaad;
      bool isEquals = true;
      // exercise
      isEquals = (itLHS == itRHS);
      // verify
      assertUnit(isEquals == false);
      assertUnit((custom::BST<Spy>::BNode*)0xbaadf00d == itLHS.pNode);
      assertUnit((custom::BST<Spy>::BNode*)0xf00dbaad == itRHS.pNode);
      // teardown
      itLHS.pNode = nullptr;
      itRHS.pNode = nullptr;
   }

   // Equalivant operator for iterator, equals
   void test_equals_equals()
   {  // setup
      custom::BST<Spy>::iterator itLHS;
      custom::BST<Spy>::iterator itRHS;
      itLHS.pNode = (custom::BST<Spy>::BNode*)0xbaadf00d;
      itRHS.pNode = (custom::BST<Spy>::BNode*)0xbaadf00d;
      bool isEquals = false;
      // exercise
      isEquals = (itLHS == itRHS);
      // verify
      assertUnit(isEquals == true);
      assertUnit((custom::BST<Spy>::BNode*)0xbaadf00d == itLHS.pNode);
      assertUnit((custom::BST<Spy>::BNode*)0xbaadf00d == itRHS.pNode);
      // teardown
      itLHS.pNode = nullptr;
      itRHS.pNode = nullptr;
   }

   // Assignment operator for iterator, equals
   void test_assign()
   {  // setup
      custom::BST<Spy>::iterator itLHS;
      custom::BST<Spy>::iterator itRHS;
      custom::BST<Spy>::iterator * pIt = nullptr;
      itLHS.pNode = (custom::BST<Spy>::BNode*)0xbaadf00d;
      itRHS.pNode = (custom::BST<Spy>::BNode*)0xf00dbaad;
      // exercise
      pIt = &(itLHS = itRHS);
      // verify
      assertUnit((custom::BST<Spy>::BNode*)0xf00dbaad == itLHS.pNode);
      assertUnit((custom::BST<Spy>::BNode*)0xf00dbaad == itRHS.pNode);
      assertUnit(pIt == &itLHS);
      // teardown
      itLHS.pNode = nullptr;
      itRHS.pNode = nullptr;
   }
   ...
   {  // setup
      ...
      assertUnit(Spy::numCopyMove() == 0);
      assertUnit(Spy::numAssignMove() == 0);
      assertUnit(pairBST.first.pNode != nullptr);
      assertUnit(pairBST.second == true);
      if (pairBST.first.pNode != nullptr)
   ...
   {  // setup
      ...
      assertUnit(Spy::numCopyMove() == 0);
      assertUnit(Spy::numAssignMove() == 0);
      assertUnit(itReturn.pNode == nullptr);
      assertEmptyFixture(bst);
   }  // teardown
   ...
   {  // setup
      ...
      custom::BST <Spy> bst;
      setupStandardFixture(bst);
      custom::BST <Spy>::iterator it = bst.root;
      custom::BST <Spy>::iterator itReturn = nullptr;
      Spy::reset();

      // exercise
      itReturn = bst.erase(it);
      ...
      assertUnit(bst.numElements == 6);
      assertUnit(itReturn.pNode == bst.root);
      ...
      if (bst.root)
      {
         ...
         if (bst.root->pLeft)
         {
            assertUnit(bst.root->pLeft->data == Spy(30));
            assertUnit(bst.root->pLeft->pParent == bst.root);
            assertUnit(bst.root->pLeft->pLeft != nullptr);
            if (bst.root->pLeft->pLeft)
            {
            ...
            {
               assertUnit(bst.root->pLeft->pRight->data == Spy(40));
               assertUnit(bst.root->pLeft->pRight->pParent == bst.root->pLeft);
               assertUnit(bst.root->pLeft->pRight->pLeft == nullptr);
               assertUnit(bst.root->pLeft->pRight->pRight == nullptr);
            }
         }
         assertUnit(bst.root->pRight != nullptr);
         if (bst.root->pRight)
